...
export default function Stats() {
  return (
    <section className="stats md:py-10 py-6 px-4 lg:px-0 text-white mt-10">
      <div className="container mx-auto flex flex-wrap-reverse lg:flex-nowrap lg:gap-20 gap-y-12">
        <img src="https://ik.imagekit.io/0s9lwb2yr/Coinflow/Images/World_Map_o63prOPB8.svg?updatedAt=1679748042185" alt="World map" className='world-map w-full lg:w-1/2 object-cover' />
