    ...
    <section className="hero">
      <div className='w-full h-full flex flex-col gap-4 items-center justify-center container mx-auto px-4'>
        ...
        <div className='flex gap-5 mt-4'>
          <button className='text-white border-solid border-[1px] border-white rounded-full px-4 py-2 md:px-6 md:py-[10px] hover:bg-jet transition-all'>
            <i className="fa-solid fa-microchip mr-3"></i>
            Launch App
          </button>
          <button className='bg-white px-4 py-2 text-black md:px-6 md:py-[10px] rounded-full font-medium'>
